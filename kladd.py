                        ...
                        for event in pygame.event.get():
                            ...
                            if event.type == pygame.KEYDOWN:
                                ...
                                if player.current_level == player.max_level:
                                    ...
                                    pygame.draw.rect(screen,color,input_rect,False ,10)
                                    pygame.draw.rect(screen,(95,158,160),input_rect,2 ,10)
                                    blitlines(screen, "Du uppnådde level 10\nGrattis, du har VUNNIT spelet", userfont, textcolor, 20, 850)
                                    pygame.display.update()
                                ...
                                if player.lifes == 0:
                                    ...
                                    pygame.draw.rect(screen,color,input_rect,False ,10)
                                    pygame.draw.rect(screen,(95,158,160),input_rect,2 ,10)
                                    blitlines(screen, "Ditt HP nådde 0/10\nSpelet är slut, du förlorade", userfont, textcolor, 20, 850)
                                    pygame.display.update()
                                    pygame.time.delay(5000)
                                    sys.exit()
